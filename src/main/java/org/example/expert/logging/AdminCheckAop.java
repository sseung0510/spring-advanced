...
public class AdminCheckAop {
    ...
    public Object approachAdmin(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        try {
            ...
            params.put("requestUserId", String.valueOf(request.getAttribute("userId")));
            params.put("start", LocalDateTime.now());
            params.put("requestURL", decodedRequestURI);
            params.put("requestBody", body.isEmpty() ? null : body);
        } catch (Exception e) {
        ...
        log.info("approachAdmin - User: {}, Time: {}, URI: {}, requestBody: {}, responseBody: {}",
